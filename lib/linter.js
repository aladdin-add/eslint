...
/**
 * normalize variable.writeable to support readonly/writable/off
 * @param {string | boolean} value the passed writeable value
 * @returns {string} normalized value
 */
function normalizedWriteable(value) {
    if (value === true) {
        return "writeable";
    }
    if (value === false) {
...
function addDeclaredGlobals(globalScope, configGlobals, commentDirectives) {
    Object.keys(configGlobals).forEach(name => {
        ...
        variable.writeable = normalizedWriteable(value);
    });
