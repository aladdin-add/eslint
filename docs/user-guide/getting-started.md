...
After running `eslint --init`, you'll have a `.eslintrc.{js,cjs,json,yaml,yml}` file in your directory. In it, you'll see some rules configured like this:
...
Your `.eslintrc.{js,cjs,json,yaml,yml}` configuration file will also include the line:
